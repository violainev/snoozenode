 ...
 * @author Eugen Feller
 */
public class LocalControllerIncreasingTemperatureAverage
    implements Comparator<LocalControllerDescription> 
{
     ...
     */
    public LocalControllerIncreasingTemperatureAverage(ResourceDemandEstimator estimator)
    {
                             ...
                             LocalControllerDescription localController2)
    {
        ...
        Double lTemp1 = getAverageTemperature(temps1);
        Double lTemp2 = getAverageTemperature(temps2);
    ...
    private Double getAverageTemperature(LRUCache<Long,Metric> temperatures)
    {
        Double metricAverage = 0d;
        for (Entry<Long, Metric> entry : temperatures.entrySet())
        {
        	metricAverage = Double.valueOf(metricAverage + entry.getValue().getValue() / temperatures.size());
        }
