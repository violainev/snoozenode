...
import org.inria.myriads.snoozenode.groupmanager.managerpolicies.relocation.impl.SimpleOverheatRelocation;
...
public final class GroupManagerPolicyFactory 
{
                                                                       ...
                                                                       ResourceDemandEstimator estimator) 
    {
        ...
        switch (relocationPolicy) 
        {
            ...
            case SimpleOverheatRelocation :
                relocation = new SimpleOverheatRelocation(estimator);
                break;
